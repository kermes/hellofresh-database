...
<project-guidelines>
- Use the localized_route route helper for localized routes
- Use routes/web-localized.php for localized routes
- Don't use padding oder margin class on flux elements, linke `<flux:card>`
